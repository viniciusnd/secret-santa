...
export default function Homepage() {
  ...
  return (
    <div className="min-h-screen bg-red-700">
      ...
      <div className="flex flex-row justify-center items-center mt-40 space-x-5 md:space-x-5">
        ...
        <h1 className="flex flex-col justify-center items-center text-sm"><AddInput />
